                ...
                _data.delete('checks', checkId,function(err){
                  ...
                  if (checksDeleted == checksToDelete) {
                     if (!deletionErrors) {
                       ...
                       callback(500, {'Error' : 'Errors encounted while attempting to delete all of the user\'s checks. All checks may not have been deleted from the system successfully'});
                     }
                  }
                });
              });
    ...
    _data.read('users', phone, function(err, userData){
      if(!err && userData){
        ...
        if (hashedPassword == userData.hashedPassword) {
          ...
          // Store the token 
          _data.create('tokens', tokenId, tokenObject, function(er){
            if (!err) {
...
// Contaner for all the checks methods 
handlers._checks = {};
